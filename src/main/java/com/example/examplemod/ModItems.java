...
public class ModItems {
    ...
    //add the Item you have just created to the Tab of your choice there will be more instructions over
    // there make sure to capitalize the name of your new Item
